...
HUMAN_RDM_FOLDER = "../data/triplets_results/final_experiment/cleaned_results/rdms_human_experiment_rsa" #"../data/triplets_results/own_data/cleaned_results/rdms_human_experiment_rsa" #"../data/rdms_human_experiment_rsa"
...
for seed in seeds:
    ...
    DQN_RDM_BASE_FOLDER = f"../data/test_16_rdms/selected_subset_15/{seed}" #"../data/DQN_rdms"
    SAVE_FOLDER = f"../data/triplets_results/final_experiment/cleaned_results/test_16_RSA/optimized_RDMs/{seed}" #"../data/triplets_results/own_data/cleaned_results/RSA_results/pilot/{seed}" #"../data/test_16_RSA" #"../data/RSA_results"
