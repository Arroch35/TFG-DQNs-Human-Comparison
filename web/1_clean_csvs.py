...
# =========================
input_folder = "../data/triplets_results/"
...
for file_path in all_files:
    ...
    if not triplets_df.empty:
        ...
        cols_to_keep = [
            "game_name", "trial_in_game", "total_trials_in_game",
    ...
    if not likert_df.empty:
        survey_cols = [
            "video_game_frequency", "prior_game_familiarity", "task_clarity",
            "odd_selection_difficulty", "clip_interpretation_difficulty",
            "perceived_experiment_length", "decision_confidence"
        ]
